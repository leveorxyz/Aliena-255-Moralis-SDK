...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void RC532Engine_Init_m61B3EF696BA7D71F100FD9D450C97D56C2114EF0 (RC532Engine_t8689B72AB4CA946696F6969EC59D8E19F44B7E5B* __this, bool ___forEncryption0, RuntimeObject* ___parameters1, const RuntimeMethod* method) 
{
	...
	KeyParameter_t7D587C2F307143922D40A45566DDA5FAF8368BEC* V_1 = NULL;
	{
		...
		NullCheck(L_1);
		bool L_3;
		L_3 = VirtualFuncInvoker1< bool, RuntimeObject* >::Invoke(131 /* System.Boolean System.Type::IsInstanceOfType(System.Object) */, L_1, L_2);
		if (!L_3)
		{
			goto IL_0033;
		}
...
IL_0033:
	{
		...
		NullCheck(L_10);
		bool L_12;
		L_12 = VirtualFuncInvoker1< bool, RuntimeObject* >::Invoke(131 /* System.Boolean System.Type::IsInstanceOfType(System.Object) */, L_10, L_11);
		if (!L_12)
		{
			goto IL_005a;
		}
